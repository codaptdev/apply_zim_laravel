<x-main-layout>
    ...
    @if ($fall_back !== url('/myschool/profile/edit'))
        <a class="px-10 text-2xl" href='{{url($fall_back)}}'>⬅️ Go back</a>
    @else
        <a class="px-10 text-2xl" href="/myschool">⬅️ Go back To Myschool</a>
    @endif
